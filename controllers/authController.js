...
const createSendToken = (user, statusCode, res) => {
  ...
  // Sending JWT by a cookie
  const cookieOption = {
    expires: new Date(
      Date.now() + process.env.JWT_COKKIE_EXPIRES_IN * 24 * 60 * 60 * 1000, // converting into milli second
    ),
    httpOnly: true,
  };
  ...
  // Remove the password from the output while creating a new user
...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  // Refactoring below code in seperate function
